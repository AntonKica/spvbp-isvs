...
Problém s tým, ako spracovávame zamestnancov a role sme už naštiepili pri pohľade na databázu a tabuľku \enquote{ISMS setup}.
...
dokumentácie systému by bolo esenciálne pre používateľov, ktorý by chceli prakticky používať náš systém.



\section{Zhrnutie}

Praktický návrhov a zlepšení vie byť nespočetne veľa, preto by sme si na koniec dovolili zhrnúť, čo z tejto bakalárskej
práce je použiteľné a čo by bolo ešte potrebné urobiť, aby náš systém bol plnohodnotný. Použiteľné časti našej bakalárskej
prace by sme zhrnuli na:
\begin{itemize}
...
\begin{itemize}
  ...
  \item systémoví používatelia a
  \item používateľská príručka.
\end{itemize}

Pri vypracovaní bakalárskej práce a jej systému sme sa dotli iba špičky ľadovca, ďalej zostáva preskúmať to, čo sa skrýva
pod hladinou vody.
